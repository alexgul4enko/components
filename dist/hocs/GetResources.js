...
function withResources() {
  var resouces = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    ...
    function (_Component) {
      ...
      function Prefetch() {
        ...
        _defineProperty(_assertThisInitialized(_this), "isLoading", function () {
          resouces.findIndex(function (key) {
            return (0, _isEmpty["default"])((0, _get["default"])(_this.props, "[".concat(resouces, "].data")));
          }) !== -1;
        });
      ...
      _createClass(Prefetch, [{
        ...
        value: function componentDidMount() {
          ...
          Promise.all([resouces.map(function (key) {
            return (0, _get["default"])(_this2.props, "[".concat(resouces, "].fetch"), function () {})();
          })]);
        }
      }, {
        key: "render",
