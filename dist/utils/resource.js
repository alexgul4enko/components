...
function getDefaultState(resource) {
  if ((0, _has["default"])(resource, 'defaultState')) {
  ...
  if ((0, _has["default"])(resource, 'queries')) {
    defaultState = _objectSpread({}, defaultState, {
      data: {},
      filters: {}
    });
  }
...
function epic(action$, store, _ref3) {
  ...
  return action$.ofType(REQUEST).mergeMap(function (_ref4) {
    ...
    var type = meta.type,
        ...
        _meta$useGlobalErrors = meta.useGlobalErrors,
        useGlobalErrors = _meta$useGlobalErrors === void 0 ? false : _meta$useGlobalErrors,
        isList = meta.isList,
    ...
    return (0, _concat.concat)((0, _of.of)(!forceUpdates && setLoading(true, meta), !forceUpdates && setErrors({}, meta), !(0, _isEmpty["default"])(queries) && setFilters((0, _pick["default"])(payload, queries), meta)), (0, _fromPromise.fromPromise)(API.run(endpoint).request(type, (0, _pick["default"])(payload, queries), (0, _omit["default"])(payload, queries))).switchMap(function (response) {
      ...
      return (0, _concat.concat)((0, _of.of)(setErrors(err.errors || err, meta), !forceUpdates && setLoading(false, meta), reject(err.errors || err, meta))).filter(Boolean);
    })).filter(Boolean);
  });
}
...
function combineReducers(reducers) {
  ...
  return function () {
    ...
    switch (action.type) {
      case CLEAR_ALL:
        return (0, _pick["default"])(state, ['endpoint', 'router', 'branding', 'tutorial', 'form']);
