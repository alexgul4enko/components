...
function (_Component) {
  ...
  function SwitchInput() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(SwitchInput)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(SwitchInput, [{
    ...
    value: function render() {
      ...
      }, this.props.label), React.createElement(_FormControlLabel["default"], {
